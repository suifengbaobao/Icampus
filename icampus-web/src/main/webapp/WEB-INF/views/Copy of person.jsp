	...
	<div class="main-page clearfix">
		<div class="main-page-left fl">
			...
			<ul class="main-menu clearfix">
				<li><a href="#">主页<div class="icon"></div></a></li>
				<li><a href="#">发图<div class="icon"></div></a></li>
			...
			<c:forEach var="card" items="${cardList}">
				<div class="card-con fl">
					...
					<div class="card-pic-title">
						<p>${card.title}</p>
						<p class="card-pic-user" name="${card.id}"><a class="card-delete-link" href="javascript:deleteCard(${card.id})">删除</a></p>
						<img class="xin" class="fr" src="../image/xin.png"/>
						<span id="xin_nums">${card.stars}</span>
					</div>
				</div>
			</c:forEach>
			<!-- 卡片分页管理 -->
			<div class="card-page fr" id="${pages}">
				<a id="1" class="next-page" href="javascript:queryCardList(${user.id},Number(getPage())+1)">加载更多</a>
			</div>
		</div>
	</div>
